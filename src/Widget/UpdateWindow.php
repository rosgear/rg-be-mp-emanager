...
class UpdateWindow extends Window
{
    ...
    protected function init(): void
    {
        ...
        $this->form = new Form([
            'id'     => 'update-form', // => rg-mp-emanager-update-form
            'router' => [
                'route' => $this->route,
        ...
        $this->id        = 'update'; // => rg-mp-emanager-update
        $this->ui        = 'light';
    ...
    public function renderSteps(): array
    {
        ...
        foreach ($this->steps as $step) {
            ...
            $html .= '<div class="rg-mp-emanager-update__step' . $active .'"><i class="fal fa-check"></i> ' . $title . '</div>';
        }
        return [
            'xtype' => 'container',
            'cls'   => 'rg-mp-emanager-update__steps',
            'html'  => $html
        ];
    }
    ...
    public function renderFormItems(): array
    {
        return [
            ...
            [
                'xtype' => 'container',
                'cls'   => 'rg-mp-emanager-update__notice',
                'html'  => '#{update.notice}'
            ],
            [
                'xtype' => 'hidden',
